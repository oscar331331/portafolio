 ...
 * @author pablo.abarca
 */
@WebServlet(name = "ApoderadoServlet", urlPatterns = {"/RegistroServlet","/Registro"})
        ...
        if(sesion.getAttribute("apoderadoAEditar") != null){
           //PENDIENTE
            ...
            if(id_alumno != 0){
                ...
                if(infoUsuario_up!=null){
                        sesion.setAttribute("msgError", "El correo ingresado ya se encuentra registrado");
